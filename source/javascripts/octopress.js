...
$( document ).ready(function() {
  $('.project_screenshots').each(function(i){
    ...
    $(this).find('img.fancybox').each(function(){
      ...
      img.removeClass("project_thumb");

      img.wrap('<a href="'+full+'" class="' + classes + '" rel="gallery'+_i+'" />')
        .parent().prepend('<div class="project_rollover"></div>');
      if (title != "")
      {
